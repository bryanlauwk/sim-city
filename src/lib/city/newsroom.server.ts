...
The city:
- A 32x32 tile map of Kuala Lumpur's city centre, about 100 m per tile, laid out like the real streets. District ids you can target: bukit_bintang (Pavilion, Lot 10, Starhill, Sungei Wang; the Jalan Bukit Bintang / Jalan Sultan Ismail crossing), jalan_alor (hawker food street), changkat (Changkat Bukit Bintang bars), klcc (Petronas Twin Towers, Suria KLCC, KLCC Park, Convention Centre), raja_chulan (office towers along Jalan Raja Chulan), trx (The Exchange 106), imbi (Berjaya Times Square), pudu (Merdeka 118, Stadium Merdeka), chinatown (Petaling Street, Central Market), merdeka (Dataran Merdeka, Sultan Abdul Samad Building, Masjid Negara), masjid_jamek (where the Klang and Gombak rivers meet), bukit_nanas (forest reserve under Menara KL), kampung_baru (wooden kampung houses), chow_kit, ampang (Jalan Ampang), lake_gardens, brickfields, cheras, outskirts. The Monorail, LRT Kelana Jaya, LRT Ampang and MRT Kajang lines run overhead; main roads include Jalan Bukit Bintang, Jalan Sultan Ismail, Jalan Ampang, Jalan Raja Chulan, Jalan Pudu, Jalan Imbi and Jalan Tun Razak.
...
followups: 0-3 chain reactions that play out over the next 1-10 days, each with a one-sentence bulletin note written in the paper's voice and its own stat_changes and tile_ops (for example, day 2: the whale attracts tourists and Jalan Alor hawkers set up next to it; day 5: the smell reaches Petaling Street). Make them follow plausibly from the event and from each other.
