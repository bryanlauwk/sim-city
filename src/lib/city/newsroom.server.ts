...
Give each actor a short label, a fitting hex colour and a size 1-8 (a whale is about 4, a kaiju 6). crowd is how people on the street react: flee, gather (gawk), celebrate or ignore. responders are the services that rush in: fire, police, ambulance, army, cleanup. Use an empty actors list for quiet policy news.
